...
function ensureOfflineComponents(firestoreClient) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        return tslib.__generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    if (!!firestoreClient.offlineComponents) return [3 /*break*/, 2];
                    logDebug(LOG_TAG$a, 'Using default OfflineComponentProvider');
                    return [4 /*yield*/, setOfflineComponentProvider(firestoreClient, new MemoryOfflineComponentProvider())];
                case 1:
                    _d.sent();
                    _d.label = 2;
                case 2: return [2 /*return*/, firestoreClient.offlineComponents];
            }
        });
    });
}
function ensureOnlineComponents(firestoreClient) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        return tslib.__generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    if (!!firestoreClient.onlineComponents) return [3 /*break*/, 2];
                    logDebug(LOG_TAG$a, 'Using default OnlineComponentProvider');
                    return [4 /*yield*/, setOnlineComponentProvider(firestoreClient, new OnlineComponentProvider())];
                case 1:
                    _d.sent();
                    _d.label = 2;
                case 2: return [2 /*return*/, firestoreClient.onlineComponents];
            }
        });
    });
}
function setOfflineComponentProvider(firestoreClient, offlineComponentProvider) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        var configuration;
        var _this = this;
        return tslib.__generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    return [4 /*yield*/, firestoreClient.getConfiguration()];
                case 1:
                    configuration = _d.sent();
                    return [4 /*yield*/, offlineComponentProvider.initialize(configuration)];
                case 2:
                    _d.sent();
                    firestoreClient.setCredentialChangeListener(function (user) { return firestoreClient.asyncQueue.enqueueRetryable(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
                        return tslib.__generator(this, function (_d) {
                            switch (_d.label) {
                    ...
                    offlineComponentProvider.persistence.setDatabaseDeletedListener(function () { return firestoreClient.terminate(); });
...
function setOnlineComponentProvider(firestoreClient, onlineComponentProvider) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    firestoreClient.asyncQueue.verifyOperationInProgress();
                    return [4 /*yield*/, ensureOfflineComponents(firestoreClient)];
                case 1:
                ...
                case 3:
                    ...
                    firestoreClient.setCredentialChangeListener(function (user) { return firestoreClient.asyncQueue.enqueueRetryable(function () { return remoteStoreHandleCredentialChange(onlineComponentProvider.remoteStore, user); }); });
...
function getPersistence(firestoreClient) {
    return ensureOfflineComponents(firestoreClient).then(function (o) { return o.persistence; });
}
/** Enables the network connection and re-enqueues all pending operations. */
function firestoreClientEnableNetwork(firestoreClient) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        var _this = this;
        return tslib.__generator(this, function (_d) {
            return [2 /*return*/, firestoreClient.asyncQueue.enqueue(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
                    var persistence, remoteStore;
                    return tslib.__generator(this, function (_d) {
                        switch (_d.label) {
                            case 0: return [4 /*yield*/, getPersistence(firestoreClient)];
                            case 1:
                                persistence = _d.sent();
                                return [4 /*yield*/, getRemoteStore(firestoreClient)];
                            case 2:
                                remoteStore = _d.sent();
...
function getRemoteStore(firestoreClient) {
    return ensureOnlineComponents(firestoreClient).then(function (o) { return o.remoteStore; });
}
/** Disables the network connection. Pending operations will not complete. */
function firestoreClientDisableNetwork(firestoreClient) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        var _this = this;
        return tslib.__generator(this, function (_d) {
            return [2 /*return*/, firestoreClient.asyncQueue.enqueue(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
...
function getSyncEngine(firestoreClient) {
    return ensureOnlineComponents(firestoreClient).then(function (c) { return c.syncEngine; });
}
/**
 ...
 */
function firestoreClientWaitForPendingWrites(firestoreClient) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        var deferred;
        var _this = this;
        return tslib.__generator(this, function (_d) {
            deferred = new Deferred();
            firestoreClient.asyncQueue.enqueueAndForget(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
                var syncEngine;
                return tslib.__generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, getSyncEngine(firestoreClient)];
                        case 1:
                            syncEngine = _d.sent();
...
function getEventManager(firestoreClient) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        var onlineComponentProvider, eventManager;
        return tslib.__generator(this, function (_d) {
            switch (_d.label) {
                case 0: return [4 /*yield*/, ensureOnlineComponents(firestoreClient)];
                case 1:
...
function firestoreClientListen(firestoreClient, query, options, observer) {
    var _this = this;
    ...
    firestoreClient.asyncQueue.enqueueAndForget(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_d) {
            switch (_d.label) {
                case 0: return [4 /*yield*/, getEventManager(firestoreClient)];
                case 1:
...
function firestoreClientGetDocumentFromLocalCache(firestoreClient, docKey) {
    var _this = this;
    var deferred = new Deferred();
    firestoreClient.asyncQueue.enqueueAndForget(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
        var localStore;
        return tslib.__generator(this, function (_d) {
            switch (_d.label) {
                case 0: return [4 /*yield*/, getLocalStore(firestoreClient)];
                case 1:
                    localStore = _d.sent();
...
function firestoreClientGetDocumentViaSnapshotListener(firestoreClient, key, options) {
    var _this = this;
    ...
    firestoreClient.asyncQueue.enqueueAndForget(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    eventManager = _d.sent();
                    return [2 /*return*/, readDocumentViaSnapshotListener(eventManager, firestoreClient.asyncQueue, key, options, deferred)];
            }
        });
    }); });
    return deferred.promise;
}
function getLocalStore(firestoreClient) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        return tslib.__generator(this, function (_d) {
            return [2 /*return*/, ensureOfflineComponents(firestoreClient).then(function (c) { return c.localStore; })];
        });
    });
}
function firestoreClientGetDocumentsFromLocalCache(firestoreClient, query) {
    var _this = this;
    var deferred = new Deferred();
    firestoreClient.asyncQueue.enqueueAndForget(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
        var localStore;
...
function firestoreClientGetDocumentsViaSnapshotListener(firestoreClient, query, options) {
    var _this = this;
    if (options === void 0) { options = {}; }
    var deferred = new Deferred();
    firestoreClient.asyncQueue.enqueueAndForget(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    eventManager = _d.sent();
                    return [2 /*return*/, executeQueryViaSnapshotListener(eventManager, firestoreClient.asyncQueue, query, options, deferred)];
            }
        });
    }); });
    return deferred.promise;
}
function firestoreClientWrite(firestoreClient, mutations) {
    var _this = this;
    var deferred = new Deferred();
    firestoreClient.asyncQueue.enqueueAndForget(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
        var syncEngine;
...
function firestoreClientAddSnapshotsInSyncListener(firestoreClient, observer) {
    var _this = this;
    var wrappedObserver = new AsyncObserver(observer);
    firestoreClient.asyncQueue.enqueueAndForget(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
        var eventManager;
...
function getDatastore(firestoreClient) {
    return ensureOnlineComponents(firestoreClient).then(function (c) { return c.datastore; });
}
/**
 ...
 */
function firestoreClientTransaction(firestoreClient, updateFunction) {
    var _this = this;
    var deferred = new Deferred();
    firestoreClient.asyncQueue.enqueueAndForget(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
        var datastore;
        return tslib.__generator(this, function (_d) {
            switch (_d.label) {
                case 0: return [4 /*yield*/, getDatastore(firestoreClient)];
                case 1:
                    datastore = _d.sent();
                    new TransactionRunner(firestoreClient.asyncQueue, datastore, updateFunction, deferred).run();
                    return [2 /*return*/];
            }
        });
    }); });
...
var Firestore = /** @class */ (function () {
    ...
    Firestore.prototype.onSnapshotsInSync = function (arg) {
        ...
        if (isPartialObserver(arg)) {
            return firestoreClientAddSnapshotsInSyncListener(this._firestoreClient, arg);
        }
        else {
            var observer = {
                next: arg
            };
            return firestoreClientAddSnapshotsInSyncListener(this._firestoreClient, observer);
        }
    };
    Firestore.prototype._ensureClientConfigured = function () {
        if (!this._firestoreClient) {
    ...
    Firestore.prototype.configureClient = function () {
        var databaseInfo = this.makeDatabaseInfo();
        this._firestoreClient = new FirestoreClient(this._credentials, this._queue, databaseInfo);
    };
    ...
    Firestore.prototype.runTransaction = function (updateFunction) {
        var _this = this;
        this._ensureClientConfigured();
        return firestoreClientTransaction(this._firestoreClient, function (transaction) {
...
var WriteBatch = /** @class */ (function () {
    ...
    WriteBatch.prototype.commit = function () {
        ...
        if (this._mutations.length > 0) {
            var firestoreClient = this._firestore._ensureClientConfigured();
...
var DocumentReference = /** @class */ (function (_super) {
    ...
    function DocumentReference(_key, firestore, _converter) {
        ...
        _this._firestoreClient = _this.firestore._ensureClientConfigured();
        return _this;
    }
    ...
    DocumentReference.prototype.set = function (value, options) {
        ...
        return firestoreClientWrite(this._firestoreClient, parsed.toMutations(this._key, Precondition.none()));
    };
    DocumentReference.prototype.update = function (fieldOrUpdateData, value) {
        ...
        return firestoreClientWrite(this._firestoreClient, parsed.toMutations(this._key, Precondition.exists(true)));
    };
    ...
    DocumentReference.prototype.onSnapshot = function () {
        ...
        return firestoreClientListen(this._firestoreClient, newQueryForPath(this._key.path), internalOptions, observer);
    };
    DocumentReference.prototype.get = function (options) {
        var _this = this;
        if (options && options.source === 'cache') {
            return firestoreClientGetDocumentFromLocalCache(this._firestoreClient, this._key).then(function (doc) { return new DocumentSnapshot(_this.firestore, _this._key, doc, 
            /*fromCache=*/ true, doc instanceof Document ? doc.hasLocalMutations : false, _this._converter); });
        }
        else {
            return firestoreClientGetDocumentViaSnapshotListener(this._firestoreClient, this._key, options).then(function (snapshot) { return _this._convertToDocSnapshot(snapshot); });
        }
    };
...
var Query = /** @class */ (function () {
    ...
    Query.prototype.onSnapshot = function () {
        ...
        var firestoreClient = this.firestore._ensureClientConfigured();
        return firestoreClientListen(firestoreClient, this._query, options, observer);
    };
    Query.prototype.get = function (options) {
        ...
        return (options && options.source === 'cache'
            ...
            : firestoreClientGetDocumentsViaSnapshotListener(firestoreClient, this._query, options)).then(function (snap) { return new QuerySnapshot(_this.firestore, _this._query, snap, _this._converter); });
    };
    return Query;
}());
